...
# -> .../Desktop/Codigos/M7/Hito2/day10
...
#     # print(f'--> {inmuebles}')
#     # <QuerySet [<Inmueble: Inmueble object (18)>]>
    
#     #* Para Leer o guardar datos en el archivo datos.txt
#     with open("m7_python/outputs/datos.txt", "a") as file:
...
#* Consulta ORM (Comuna), Funcion mas dinamica:
def listado_inmuebles_comuna_orm(comuna, descr=None):
    # inmuebles = Inmueble.objects.all()
    # comuna__nombre__icontains
    # Guardar la data en nuestro .txt con nuestro OPEN de python
...
# Para ejecutar script --> python m7_python/temp.py
