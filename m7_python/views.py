...
# STEP --> CREAR el FORM de Registro (crear usuario)
...
#* EDITAR PERFIL -> Formularios a usar UserForm, UserEditProfileForm
@login_required
...
#TODO________________________________________________________________________________________________________________________
#* VISTAS SIMPLES 

# Vista para redireccionamiento del about
def about(request):
